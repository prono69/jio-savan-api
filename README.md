## Serverless Unofficial JioSaavn API Written in Javascript
### This project is a part of [Jiosaavn Api](https://github.com/cachecleanerjeet/JiosaavnAPI "Jiosaavn Api") of [mine](https://thetuhin.com "mine")
...
//example
https://jiosaavn-api.vercel.app/search?query=makhna
```
...
//example
https://jiosaavn-api.vercel.app/song?id=hotE59KE
```
...
//example
https://jiosaavn-api.vercel.app/lyrics?id=hotE59KE
```
*The Song Id is Previously Fetched <tt>ID</tt> Object from Search.*
...
//example
https://jiosaavn-api.vercel.app/albumsearch?query=drive
```
...
//example
https://jiosaavn-api.vercel.app/album?id=17488163
```
...
//example
https://jiosaavn-api.vercel.app/link?query=https://www.jiosaavn.com/song/makhna/GAcfdEEJfHY
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fcachecleanerjeet%2Fserverless-jiosaavn-api)
